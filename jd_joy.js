...
const lks=$.md5("ztmFUCxcPMNyUq0P"+lkt);
...
function getDeskGoodDetails() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/getDeskGoodDetails?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P",
...
function followScan(sku) {
  return new Promise(resolve => {
    ...
    let opt = {
      url: "//jdjoy.jd.com/common/pet/scan?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P",
      // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
      method: "POST",
      data: body,
      credentials: "include",
...
function scanMarket(type, body, cType = 'application/json') {
  return new Promise(resolve => {
    ...
    let opt = {
      ...
      url: `//jdjoy.jd.com/common/pet/${type}?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P`,
      method: "POST",
      data: body,
      credentials: "include",
...
function doScanMarket(type, body) {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: `//jdjoy.jd.com/common/pet/icon/click?iconCode=${type}&linkAddr=${body}&reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P`,
      // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
      method: "GET",
      credentials: "include",
      header: {"content-type": "application/json"}
...
function getFood(type) {
  return new Promise(resolve => {
    ...
    let opt = {
      // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
      url: `//draw.jdfcloud.com/common/pet/getFood?reqSource=weapp&taskType=${type}&reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P`,
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function dofollowShop(shopId) {
  return new Promise(resolve => {
    ...
    let opt = {
      // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
      url: `//jdjoy.jd.com/common/pet/icon/click?iconCode=follow_shop&linkAddr=${shopId}&reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P`,
      method: "GET",
      credentials: "include",
...
function followShop(shopId) {
  return new Promise(resolve => {
    ...
    let opt = {
      // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
      url: "//draw.jdfcloud.com/common/pet/followShop?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P",
      method: "POST",
      data: body,
      credentials: "include",
      header: {"content-type":"application/x-www-form-urlencoded"}
...
function enterRoom() {
  return new Promise(resolve => {
    ...
    let opt = {
      // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
      url: `//draw.jdfcloud.com/common/pet/enterRoom/h5?reqSource=h5&invitePin=&openId=&invokeKey=ztmFUCxcPMNyUq0P`,
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function appGetPetTaskConfig() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P",
...
function feedPets(feedNum) {
  return new Promise(resolve => {
    ...
    let opt = {
      // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
      url: `//draw.jdfcloud.com/common/pet/feed?feedCount=${feedNum}&reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P`,
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function getPetRace() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/combat/detail/v2?help=false&reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P",
      // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
      method: "GET",
      data: {},
      credentials: "include",
...
function getRankList() {
  return new Promise(resolve => {
    ...
    $.raceUsers = [];
    let opt = {
      url: "//jdjoy.jd.com/common/pet/combat/getRankList?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P",
      // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
      method: "GET",
      data: {},
      credentials: "include",
...
function runMatch(teamLevel, timeout = 5000) {
  ...
  return new Promise(async resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: `//jdjoy.jd.com/common/pet/combat/match?teamLevel=${teamLevel}&reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P`,
...
function getBackupInfo() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/combat/getBackupInfo?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P",
      // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
      method: "GET",
      data: {},
      credentials: "include",
...
function getWinCoin() {
  return new Promise(resolve => {
    ...
    let opt = {
      // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
      url: "//draw.jdfcloud.com/common/pet/combat/detail/v2?help=false&reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P",
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function receiveJoyRunAward() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/combat/receive?reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P",
      // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
      method: "GET",
      data: {},
      credentials: "include",
...
function getSupplyInfo(showOrder) {
  return new Promise(resolve => {
    ...
    let opt = {
      // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
      url: `//draw.jdfcloud.com/common/pet/combat/getSupplyInfo?showOrder=${showOrder}&reqSource=h5&invokeKey=ztmFUCxcPMNyUq0P`,
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
